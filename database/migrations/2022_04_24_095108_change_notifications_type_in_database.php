...
class ChangeNotificationsTypeInDatabase extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('notifications')->where('type', 'App\Notifications\Contact\TicketCreated')->update(['type' => 'ContactCreated']);
        DB::table('notifications')->where('type', 'App\Notifications\UserRegistered')->update(['type' => 'UserRegistered']);
        DB::table('notifications')->where('type', 'App\Notifications\User\SellerRegistered')->update(['type' => 'SellerRegistered']);
        DB::table('notifications')->where('type', 'App\Notifications\UserCreated')->update(['type' => 'UserCreated']);
        DB::table('notifications')->where('type', 'App\Notifications\User\SellerCreated')->update(['type' => 'SellerCreated']);
