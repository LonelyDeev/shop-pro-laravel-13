            ...
            <div class="content-body">
                ...
                <section id="description" class="card">
                    <div class="card-header">
                        ...
                        <button class="btn btn-success" data-toggle="modal" data-target="#modal-add"><i class="fa fa-plus mr-1"></i>افزودن منو</button>
                    </div>
                    <div id="main-block" class="card-content">
                        <div class="card-body p-rl-0-responsive-500">
                            <!-- menus -->
                ...
                <form id="create-menu" action="#">
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-12" id="menu-icon-div">
                                <div class="form-group">
                                    <label>آیکون (کلاس آیکون)</label>
                                    <input type="text" class="form-control" name="icon" placeholder="مثال: mdi mdi-menu">
                            ...
                            <div class="col-12" id="menu-category-div" style="display: none;">
                                ...
                                <div class="form-group">
                                    <label>آیکون (کلاس آیکون)</label>
                                    <input type="text" class="form-control" name="category_icon" placeholder="مثال: mdi mdi-menu">
                                    <p class="text-muted">این فیلد اختیاری است</p>
                                </div>
                ...
                <form id="edit-form" action="#">
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-12" id="edit-menu-icon-div">
                                <div class="form-group">
                                    <label>آیکون (کلاس آیکون)</label>
                                    <input type="text" class="form-control" name="icon" placeholder="مثال: mdi mdi-menu">
                                    <p class="text-muted">این فیلد اختیاری است</p>
