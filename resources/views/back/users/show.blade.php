            ...
            <div class="content-body">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="card user-statistics-card">
                            ...
                            <div class="card-footer">
                                <span>
                                    <a class="card-link">مشاهده همه <i class="fa fa-angle-left"></i></a>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="card user-statistics-card">
                            ...
                            <div class="card-footer">
                                <span>
                                    <a href="{{route('admin.users.notifications',['user'=>$user])}}" class="card-link">مشاهده همه <i class="fa fa-angle-left"></i></a>
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <section  class="card">
                    <div class="card-header">
                        ...
                        <a href="{{route('admin.users.notification.create',['user'=>$user])}}"><div class="c-mega-campaigns__btns-green-plus uk-margin-remove">
