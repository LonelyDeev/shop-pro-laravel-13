                                        ...
                                        <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <dd class="col-md-6">
                                                        ...
                                                        @else
                                                            ...
                                                            <a href="{{ route('admin.sellers.show', ['seller' => $ticket->seller]) }}" target="_blank"><i class="feather icon-external-link"></i></a>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    ...
                                                    <dd class="col-md-6">
                                                        <select name="type" id="tickets-type" class="form-control valid" data-action="{{route('admin.tickets.type',$ticket)}}" aria-invalid="false">
