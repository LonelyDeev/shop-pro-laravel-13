                    ...
                    <div id="main-card" class="card-content">
                        <div class="card-body">
                            <div class="col-12 col-md-10 offset-md-1">
                                <form class="form" id="notifications-create-form" data-redirect="{{ route('admin.sellers.notifications',['seller'=>$seller]) }}" action="{{ route('admin.sellers.notification.update', ['notification' => $notification,'seller'=>$seller]) }}" method="post">
                                    @csrf
                                    @method('put')
                                    <div class="form-body">
                                        <div class="row">
