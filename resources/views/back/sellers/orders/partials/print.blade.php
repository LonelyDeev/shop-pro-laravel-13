                ...
                <div class="col-4 pr-0">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td class="p-0">{{ number_format($order->priceSellerWithoutDiscount($seller->id)) }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="p-0">{{ number_format($order->totalDiscountSeller($seller->id)) }}</td>
                        </tr>

                        <tr class="factor-table-color">
                            <th class="p-0">مجموع فاکتور:</th>
                            <td class="p-0">{{ number_format($order->priceseller($seller->id)) }} تومان</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
