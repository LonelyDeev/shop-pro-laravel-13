    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                <!-- filter start -->
                {{--@include('back.sellers.orders.filters')--}}
                <!-- filter end -->
                ...
                <section id="main-card" class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <div class="datatable datatable-bordered datatable-head-custom" id="orders_datatable" data-action="{{ route('admin.sellers.seller_orders.ApiIndex',$seller) }}">
    ...
    <div class="modal fade text-left" id="orders-export-modal" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <form id="orders-export-form" action="{{ route('admin.seller.orders.export',['seller'=>$seller]) }}">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
...
@push('scripts')
    <script src="{{ asset('back/assets/js/pages/sellers/orders.js') }}?v=7"></script>
@endpush
