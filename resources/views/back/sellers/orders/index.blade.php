                ...
                <section id="main-card" class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <div class="datatable datatable-bordered datatable-head-custom" id="orders_datatable" data-action="{{ route('admin.sellers.orders.apiIndex') }}">
    ...
    <div class="modal fade text-left" id="orders-export-modal" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <form id="orders-export-form" action="{{ route('admin.sellers.orders.exportOrders') }}">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
