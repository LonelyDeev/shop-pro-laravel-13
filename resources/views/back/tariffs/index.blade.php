            ...
            <div class="content-body">
                ...
                <section class="card">
                    <div class="card-header">
                        ...
                        <div>
                            <a href="{{ route('admin.tariffs.create', ['carrier' => $carrier]) }}" class="btn personal-info-btn waves-effect waves-light"><i class="feather icon-plus"></i> ایجاد تعرفه</a>
                        </div>
                    </div>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="dropdown dropdown-action">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenu{{ $tariff->id }}">
                                                                ...
                                                                <a class="dropdown-item" href="{{ route('admin.tariffs.edit', ['tariff' => $tariff]) }}"><i class="fa-solid fa-pencil mr-1"></i>ویرایش</a>
                                                                <div class="dropdown-divider"></div>

                                                                <button class="dropdown-item btn-delete" data-action="{{ route('admin.tariffs.destroy', ['tariff' => $tariff]) }}"  data-toggle="modal" data-target="#delete-modal"><i class="fa-solid fa-trash-can mr-1"></i> حذف</button>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
