    ...
    <table class="table">
        <tbody>
            ...
            <tr>
                ...
                @elseif($wallet_history->wallet->seller)
                    <td>
                        {{ get_seller_info($wallet_history->wallet->seller_id)->fullname }}<a class="float-right" href="{{ route('admin.sellers.show', ['seller' => $wallet_history->wallet->seller]) }}" target="_blank"><i class="feather icon-external-link"></i></a>
                    </td>
                @else
                    <td>
