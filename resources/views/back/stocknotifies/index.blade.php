                                                ...
                                                <tr id="stock_notify-{{ $stock_notify->id }}-tr">
                                                    ...
                                                    <td class="text-center">
                                                        <div class="dropdown dropdown-action">
                                                            <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenu{{ $stock_notify->id }}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                <i class="fa-solid fa-ellipsis-vertical"></i>
                                                            </button>
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenu{{ $stock_notify->id }}">
                                                                <button type="button" data-stock_notify="{{ $stock_notify->id }}" class="dropdown-item mr-1 waves-effect waves-light show-stock_notify"><i class="fa-regular fa-eye mr-1"></i>مشاهده</button>
                                                                <div class="dropdown-divider"></div>

                                                                <button class="dropdown-item btn-delete" data-stock_notify="{{ $stock_notify->id }}" data-id="{{ $stock_notify->id }}" data-toggle="modal" data-target="#delete-modal"><i class="fa-solid fa-trash-can mr-1"></i> حذف</button>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
