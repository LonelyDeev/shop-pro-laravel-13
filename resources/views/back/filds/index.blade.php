                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb no-border">
                                    ...
                                    <li class="breadcrumb-item active">لیست فیلدها
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="card-header">
                        ...
                        <div class="heading-elements">
                            <ul class="list-inline mb-0">
                                <li>
                                    <a href="{{ route('admin.filds.create') }}">
                                        <button type="button"
                                            class="btn personal-info-btn mb-1 waves-effect waves-light"><i
                                                class="fa fa-plus"></i> افزودن فیلد جدید</button>
                                    </a>
                                </li>
                            </ul>
                        </div>
                                        ...
                                        <tbody>
                                            @foreach ($items as $item)
                                                <tr id="fild-{{ $item->id }}-tr">
                                                    <td>
                                                        <span style="width: 20px;">
                                                            <label class="checkbox checkbox-single">
                                                                <input type="checkbox" value="{{ $item->id }}"><span></span>
                                                            </label>
                                                        </span>
                                                    </td>
                                                    <td><span class="d-inline-block">{{ $item->title }}</span> </td>


                                                    @php
                                                        $options = [
                                                            'input' => '(input) ورودی کلمات',
                                                            'textarea' => '(textarea) ورودی متن',
                                                            'number' => '(number) ورودی عدد',
                                                            'email' => '(email) ورودی ایمیل',
                                                            'colorPicker' => '(colorPicker) انتخاب رنگ',
                                                    ...
                                                    <td>
                                                        <span class="d-inline-block">
                                                            {{ $item->belongs_to == 'products' ? 'محصولات' : '' }}
                                                            {{ $item->belongs_to == 'users' ? 'کاربران' : '' }}
                                                            {{ $item->belongs_to == 'posts' ? 'مقالات' : '' }}
                                                        </span>
                                                    </td>
                                                            ...
                                                            <div class="dropdown-menu"
                                                                ...
                                                                @can('posts.update')
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('admin.filds.edit', ['fild' => $item]) }}"><i
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-sm" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        با حذف فیلدها دیگر قادر به بازیابی آنها نخواهید بود
                    </div>
                    <div class="modal-footer">
                        <form action="{{ route('admin.filds.multipleDestroy') }}" id="filds-multiple-delete-form">
                            @csrf
                            @method('delete')
    ...
    <div class="modal fade text-left" id="delete-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel19"
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="#" id="fild-delete-form">
                        @csrf
                        @method('delete')
