{{--
    دراپ‌زون تصویر بنر (یکپارچه با file manager سایت)
    ساختار مورد نیاز JS شما حفظ شده:
      - #button-image (clickable)
      - #image_label (input hidden)
      - .img-uploader (container img)
      - .remove-img-uploader (remove button)
      - کلاس display-hidden برای toggle visibility
...
<div class="sk-dropzone">
    <div class="sk-section-header" style="border-bottom: 1px dashed var(--sk-border-soft); padding-bottom: 1rem; margin-bottom: 1rem;">
        ...
        <div class="sk-section-titles">
            <h4 class="sk-section-title">تصویر بنر</h4>
    ...
    <div class="dropzone-wrapper" style="position: relative;">
        ...
        {{-- فیلد مخفی نگهدارنده URL تصویر --}}
        <input
            type="text"
            id="image_label"
            class="form-control display-hidden"
            name="image"
            aria-label="Image"
        ...
        {{-- دکمه dropzone (همان #button-image که JS شما انتظار دارد) --}}
        <button
            type="button"
            id="button-image"
            class="file-uploader dropzone dropzone-area dz-area {{ $hasImage ? 'has-image' : '' }}"
        ...
        >
            ...
            <div class="dz-empty " @if ($hasImage) style="display:none;" @endif>
                ...
                <h6 class="dz-title">تصویر بنر را انتخاب کنید</h6>
                <p class="dz-hint">
