                                        ...
                                        <div class="row">
                                            ...
                                            @if($filter->is_seller)
                                                    ...
                                                    <fieldset class="checkbox">
                                                        <div class="vs-checkbox-con vs-checkbox-primary checkbox-all ">
                                                            <input type="checkbox" value="1" name="is_seller" checked>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group float-right">
                                                    <button data-toggle="modal" data-target="#add-filterable-modal" type="button" class="btn personal-info-btn mb-1 waves-effect waves-light"><i class="fa fa-plus"></i> افزودن فیلتر جدید</button>
                                                </div>
                                            </div>
                                            <div class="col-12">
