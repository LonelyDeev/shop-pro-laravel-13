                                        ...
                                        <div class="row">
                                            ...
                                            @if(!$is_seller)
                                                    ...
                                                    <fieldset class="checkbox">
                                                        <div class="vs-checkbox-con vs-checkbox-primary checkbox-all ">
                                                            <input type="checkbox" value="1" name="is_seller">
                                                            <span class="vs-checkbox ">
                                                        <span class="vs-checkbox--check">
                                                            <i class="vs-icon feather icon-check"></i>
                                                        </span>
                                                    </span>
                                                            <span> برای صفحه فروشندگان؟</span>
                                                        </div>
                                                    </fieldset>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group float-right">
                                                    <button type="button" data-toggle="modal" data-target="#add-filterable-modal" type="submit" class="btn personal-info-btn mb-1 waves-effect waves-light"><i class="fa fa-plus"></i> افزودن فیلتر جدید</button>
                                                </div>
                                            </div>
                                            <div class="col-12">
