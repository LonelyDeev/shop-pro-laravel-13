...
@push('styles')
    <link rel="stylesheet" href="{{ asset('back/assets/css/pages/imports/postsExcelImport.css') }}">
@endpush
@php
    $fields = [
        'title'            => ['label' => 'عنوان',              'required' => true,  'sample' => 'آموزش لاراول از صفر'],
        'slug'             => ['label' => 'Slug',               'required' => false, 'sample' => 'laravel-tutorial'],
        'image'            => ['label' => 'تصویر شاخص',         'required' => false, 'sample' => 'https://site.com/img.jpg'],
        'content'          => ['label' => 'محتوا',              'required' => false, 'sample' => '<p>متن کامل نوشته...</p>'],
        'meta_title'       => ['label' => 'عنوان سئو',          'required' => false, 'sample' => 'آموزش جامع لاراول'],
        'meta_description' => ['label' => 'توضیحات سئو',        'required' => false, 'sample' => 'یادگیری لاراول به صورت پروژه محور'],
        'tags'             => ['label' => 'کلمات کلیدی',        'required' => false, 'sample' => 'لاراول, PHP, آموزش'],
        'publish_date'     => ['label' => 'تاریخ انتشار',       'required' => false, 'sample' => '1403/04/08'],
        'view'             => ['label' => 'تعداد بازدید',       'required' => false, 'sample' => '120'],
        'published'        => ['label' => 'پیش نویس یا انتشار', 'required' => false, 'sample' => '1'],
    ];
@endphp
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb no-border">
                                    ...
                                    <li class="breadcrumb-item">مدیریت نوشته ها</li>
                                    <li class="breadcrumb-item active">ایجاد نوشته ها از فایل Excel</li>
                                </ol>
                            </div>
                        </div>
                    </div>
            ...
            <div class="content-body">
                <section class="card import-card">
                    <div class="card-header">
                        <h4 class="card-title">
                            ...
                            افزودن نوشته ها از فایل Excel
                        </h4>
                    </div>

                    <div id="main-card" class="card-content">
                        <div class="card-body">
                            <form class="form" id="excel-create-form" action="{{ route('admin.import.posts.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 col-md-12 mb-3">
                                        <div class="import-panel">
                                            ...
                                            الزامی است و امکان حذف آن وجود ندارد.
                                        </span>
                                            </div>
                                        ...
                                        <div class="import-panel">
                                            ...
                                            <fieldset class="checkbox">
                                                <div class="vs-checkbox-con vs-checkbox-primary">
                                                    ...
                                                    <span>
                                                    بروزرسانی مقاله تکراری (در صورت وجود slug تکراری، اطلاعات مقاله به‌روزرسانی شود)
                ...
                {{-- نمایش خطاهای واردات مقالات --}}
                @php
                    $errorFiles = glob(storage_path('logs/posts_import_errors_*.json'));
                    ...
                    <div class="row mt-3">
                        ...
                        <span class="icon-wrap">
                            <i class="feather icon-alert-triangle"></i>
                                        ...
                                        <span>گزارش خطاهای واردات مقالات</span>
                                    </div>
...
@push('scripts')
    ...
    <script>
        var DELETE_ERROR_API="{{ route('admin.import.posts.delete-error') }}";
