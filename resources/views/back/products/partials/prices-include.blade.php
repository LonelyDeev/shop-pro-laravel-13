<div class="row single-price">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-12">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control warehouses-attribute-select" name="prices[{{ $loop->iteration }}][warehouse]" required>
    ...
    <div class="col-md-3 col-12">
        ...
        <div class="col-md-3 col-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control final-price" value='{{number_format($price->price())}} تومان' disabled>
            </div>
        </div>
    @if(option('multi_vendor_system_status','false')=="true")
        <div class="col-md-6">
            <div class="form-group">
                <label>فروشنده</label>
                <select class="form-control sellers" name="prices[{{ $loop->iteration }}][seller_id]">
                    <option value="">انتخاب کنید</option>
    ...
    <div class="col-md-12 text-right">
        <button type="button" class="btn btn-flat-danger waves-effect waves-light remove-product-price custom-padding">
            حذف <i class="fa fa-trash text-danger"></i>
        </button>
    </div>
