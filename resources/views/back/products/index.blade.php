            ...
            <div class="content-header row">
                ...
                <div class="content-header-right col-md-3 col-12 mb-2">
                    <div class="btn-group float-md-right">
                        <button class="btn btn-primary btn-export" data-toggle="modal" data-target="#products-export-modal">
                ...
                <section id="main-card" class="card">
                    <div class="card-header">
                        ...
                        <div class="heading-elements">
                            ...
                            <span class="badge badge-success">انتشار: {{ $statistics['active'] }}</span>
                            <span class="badge badge-danger">در انتضار انتشار: {{ $statistics['inactive'] }}</span>
                        </div>
                        {{--@can('products.export')
                            <div class="heading-elements">
