                                        ...
                                        <div class="sk-info-card">
                                            ...
                                            <div class="sk-info-card-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="motionTitle"
                                                           value="{{ old('motionTitle') }}"
                                                           class="form-control"
                                                           placeholder="Motion Title">
                                                </div>

                                                <div class="mb-3">
                                                    <label class="form-label">لینک (داخلی یا خارجی)</label>
                                                ...
                                                <div class="publish-box">
                                                    ...
                                                    <div class="publish-info">
                                                        ...
                                                        <small>اگر فعال باشد، اسلایدر بلافاصله در سایت نمایش داده
                                                            می‌شود.</small>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="sk-info-card-footer">
                                                ...
                                                <button type="submit" class="btn btn-primary px-4">
                                                    <i class="fa fa-save ms-1"></i> ذخیره اسلایدر
                                                </button>
                                            </div>
                                        </div>
                                    </div>
