        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                <section class="row flexbox-container">
                    <div class="col-xl-6 col-6 d-flex justify-content-center">
...
{{--                                </div>--}}
                                <div id="main-card" class="col-lg-12 col-12 p-0">
                                    <div class="card rounded-0 mb-0 p-2">
                                        <div class="logo-wrap text-center mt-2 mb-1">
                                        ...
                                        <p class="px-2"> اطلاعات زیر را تکمیل کنید و ماجراجویی را شروع کنید.</p>
                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-0">
                                                <form id="register-form" method="POST" action="{{ route('admin.register') }}">
                                                    ...
                                                    <button type="submit" class="btn btn-primary float-right btn-inline mb-50 w-100">ثبت نام و ورود به پنل مدیریت</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
