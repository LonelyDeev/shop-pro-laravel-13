                                                    ...
                                                    <tr id="review-{{ $review->id }}-tr">
                                                        ...
                                                        <td class="text-center text-nowrap">
                                                            <div class="dropdown dropdown-action">
                                                                <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenu{{ $review->id }}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                    <i class="fa-solid fa-ellipsis-vertical"></i>
                                                                </button>
                                                                <div class="dropdown-menu" aria-labelledby="dropdownMenu{{ $review->id }}">
                                                                    <button type="button" data-action="{{ route('admin.reviews.show', ['review' => $review]) }}" data-review="{{ $review->id }}" class="dropdown-item show-review"><i class="fa-regular fa-eye mr-1"></i>مشاهده</button>
                                                                    <div class="dropdown-divider"></div>
                                                                    <button data-review="{{ $review->id }}" data-action="{{ route('admin.reviews.destroy', ['review' => $review]) }}" type="button" class="dropdown-item btn-delete"  data-toggle="modal" data-target="#delete-modal"><i class="fa-solid fa-pencil mr-1"></i>حذف</button>
