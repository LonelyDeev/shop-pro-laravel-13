            ...
            <div class="content-body">
                ...
                <section class="card">
                    <div class="card-header">
                        <h4 class="card-title">ایجاد سوالات پر تکرار</h4>
                    </div>

                    <div id="main-card" class="card-content">
                        <div class="card-body">
                            <div class="col-12 col-md-10 offset-md-1">
                                <form class="form" id="seller-question-create-form" action="{{ route('admin.settings.seller-question-store') }}" method="Post">
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
