                ...
                <section class="users-edit">
                                            ...
                                            <div class="form-group col-md-4">
                                                <fieldset class="checkbox">
                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                        <input data-class="sms_on_seller_register" type="checkbox" name="sms_on_seller_register" {{ option('sms_on_seller_register') == 'on' ? 'checked' : '' }} >
                                                        <span class="vs-checkbox">
                    <span class="vs-checkbox--check">
                        <i class="vs-icon feather icon-check"></i>
                    </span>
                </span>
                                                        <span class="">ارسال پیامک موقع ایجاد فروشنده</span>
                                                    </div>
                                                </fieldset>
                                            </div>
                    ...
                    <span class="vs-checkbox--check">
                        <i class="vs-icon feather icon-check"></i>
                                                        ...
                                                        <span class="">تایید کاربر یا فروشنده با شماره همراه</span>
                                                    </div>
                                                </fieldset>
                                            </div>
                    ...
                    <span class="vs-checkbox--check">
                        <i class="vs-icon feather icon-check"></i>
                                            ...
                                            <div class="form-group col-md-4">
                                                <fieldset class="checkbox">
                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                        <input data-class="sms_on_order_cancelled" type="checkbox" name="sms_on_order_cancelled" {{ option('sms_on_order_cancelled') == 'on' ? 'checked' : '' }} >
                                                        <span class="vs-checkbox">
                    <span class="vs-checkbox--check">
                        <i class="vs-icon feather icon-check"></i>
                    </span>
                </span>
                                                        <span class="">ارسال پیامک به مدیر موقع لغو سفارش</span>
                                                    </div>
                                                </fieldset>
                                            </div>
                                            ...
                                            <div class="form-group col-md-4">
                                                <fieldset class="checkbox">
                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                        <input data-class="seller_sms_on_order_paid" type="checkbox" name="seller_sms_on_order_paid" {{ option('seller_sms_on_order_paid') == 'on' ? 'checked' : '' }} >
                                                        <span class="vs-checkbox">
                    <span class="vs-checkbox--check">
                        <i class="vs-icon feather icon-check"></i>
                    </span>
                </span>
                                                        <span class="">ارسال پیامک به فروشنده موقع پرداخت سفارش</span>
                                                    </div>
                                                </fieldset>
                                            </div>

                                            <!-- جدید: لغو سفارش فروشنده -->
                                            <div class="form-group col-md-4">
                                                <fieldset class="checkbox">
                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                        <input data-class="seller_sms_on_order_cancelled" type="checkbox" name="seller_sms_on_order_cancelled" {{ option('seller_sms_on_order_cancelled') == 'on' ? 'checked' : '' }} >
                                                        <span class="vs-checkbox">
                    <span class="vs-checkbox--check">
                        <i class="vs-icon feather icon-check"></i>
                    </span>
                </span>
                                                        <span class="">ارسال پیامک به فروشنده موقع لغو سفارش</span>
                                                    </div>
                                                </fieldset>
                                            </div>
                    ...
                    <span class="vs-checkbox--check">
                        <i class="vs-icon feather icon-check"></i>
                                            ...
                                            <!-- جدید: لغو سفارش کاربر -->
                                            <div class="form-group col-md-4">
                                                <fieldset class="checkbox">
                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                        <input data-class="user_sms_on_order_cancelled" type="checkbox" name="user_sms_on_order_cancelled" {{ option('user_sms_on_order_cancelled') == 'on' ? 'checked' : '' }} >
                                                        <span class="vs-checkbox">
                    <span class="vs-checkbox--check">
                        <i class="vs-icon feather icon-check"></i>
                    </span>
                </span>
                                                        <span class="">ارسال پیامک به کاربر موقع لغو سفارش</span>
                                                    </div>
                                                </fieldset>
                                            </div>
                    ...
                    <span class="vs-checkbox--check">
                        <i class="vs-icon feather icon-check"></i>
                                            ...
                                            <!-- جدید: برگشت وجه کیف پول -->
                                            <div class="form-group col-md-4">
                                                <fieldset class="checkbox">
                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                        <input data-class="wallet_refund_sms" type="checkbox" name="wallet_refund_sms" {{ option('wallet_refund_sms') == 'on' ? 'checked' : '' }} >
                                                        <span class="vs-checkbox">
                    <span class="vs-checkbox--check">
                        <i class="vs-icon feather icon-check"></i>
                    </span>
                </span>
                                                        <span class="">ارسال پیامک برگشت وجه به کیف پول</span>
                                                    </div>
                                                </fieldset>
                                            </div>
