                    ...
                    <div id="main-card" class="widgets-card-body">
                        <div class="row">
                            <div class="col-12 col-md-8">
                                <form class="form" id="widget-edit-form" action="{{ route('admin.posts-widgets.update', ['widget' => $widget]) }}" data-redirect="{{ route('admin.posts-widgets.index') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                        ...
                                        <select id="widget-key" name="key" required>
                                            ...
                                            @foreach (config('front.posts-widgets') as $key => $template_widget)
                                                <option value="{{ $key }}"
                                                        ...
                                                        data-action="{{ route('admin.posts-widgets.template', ['key' => $key]) }}"
                                                    {{ $widget->key == $key ? 'selected' : '' }}>
