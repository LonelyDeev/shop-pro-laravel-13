                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select id="widget-key" name="key" class="form-control" required>
                                                            ...
                                                            @foreach (config('front.posts-widgets') as $key => $template_widget)
                                                                <option value="{{ $key }}" data-image="{{ isset($template_widget['image']) ? theme_asset($template_widget['image']) : '' }}" data-action="{{ route('admin.posts-widgets.template', ['key' => $key]) }}">{{ $template_widget['title'] }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
