                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb no-border">
                                    ...
                                    <li class="breadcrumb-item">مدیریت مدیران
                                    </li>
                                    <li class="breadcrumb-item active">ویرایش مدیر
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
                ...
                <section id="main-card" class="card">
                    <div class="card-header">
                        <h4 class="card-title">ویرایش مدیر </h4>
                    </div>
                    <div id="main-card" class="card-content">
                        <div class="card-body">
                            <div class="col-12 col-md-10 offset-md-1">
                                <form class="form" id="user-edit-form" action="{{ route('admin.admins.update', ['admin' => $admin]) }}" method="post">
                                    @csrf
                                    @method('put')
                                    <div class="form-body">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control ltr" name="username" value="{{ $admin->username }}">
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="roles" class="form-control" name="roles[]" multiple>
                                                        @foreach ($roles as $role)
                                                            <option value="{{ $role->id }}" {{ $admin->roles()->find($role->id) ? 'selected' : '' }}>{{ $role->title }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3 mb-2">
                                                <fieldset class="checkbox">
                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                        <input type="checkbox" name="verified_at" {{ $admin->verified_at ? 'checked' : '' }}>
...
@push('scripts')
    <script src="{{ asset('back/assets/js/pages/admins/all.js') }}"></script>
    <script src="{{ asset('back/assets/js/pages/admins/create.js') }}"></script>
@endpush
