                                                ...
                                                <tr id="contact-{{ $contact->id }}-tr">
                                                    ...
                                                    <td class="text-center">
                                                        <div class="dropdown dropdown-action">
                                                            <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenu{{ $contact->id }}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                <i class="fa-solid fa-ellipsis-vertical"></i>
                                                            </button>
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenu{{ $contact->id }}">
                                                                <button class="dropdown-item show-contact"  data-contact="{{ $contact->id }}"><i class="fa-regular fa-eye mr-1"></i>نمایش</button>
                                                                    <div class="dropdown-divider"></div>
                                                                    <button class="dropdown-item btn-delete" data-contact="{{ $contact->id }}" data-id="{{ $contact->id }}"  data-toggle="modal" data-target="#delete-modal"><i class="fa-solid fa-trash-can mr-1"></i> حذف</button>
                                                            </div>
                                                        </div>
                                                    </td>
