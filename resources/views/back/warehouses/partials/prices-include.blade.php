<div class="row single-price">
                        ...
                        <select class="form-control warehouses-attribute-select" name="warehouse" required>
                            ...
                            @foreach($warehouses as $warehouse)
                                <option value="{{ $warehouse->id }}"
                                    ...
                                    {{ $price->warehouse_id == $warehouse->id ? 'selected' : '' }}>
                ...
                <div class="col-md-3 col-12">
                    <div class="form-group">
                        ...
                        <select class="form-control price-attribute-select"
                            ...
                            @php
                                // پیدا کردن attribute انتخاب شده برای این گروه
                                $selectedAttribute = $price->get_attributes()
                            ...
                            @foreach ($attributeGroup->get_attributes as $attribute)
                                <option value="{{ $attribute->id }}"
                                    ...
                                    {{ $selectedAttribute && $selectedAttribute->id == $attribute->id ? 'selected' : '' }}>
                                    {{ $attribute->name }}
                                </option>
                            @endforeach
                        </select>
    ...
    <div class="col-md-3 col-12">
        <div class="form-group">
            ...
            <input type="number" data-unit="تومان" class="form-control amount-input price" name="price" value="{{ $price->price() }}" required>
            <small class="form-text text-success amount-helper">{{ number_format($price->price()) }} تومان</small>
        </div>
    </div>
    ...
    <div class="col-md-3 col-12">
        <div class="form-group">
            ...
            <input type="number" class="form-control discount" name="discount" value="{{ $price->discount }}" min="0" max="100" placeholder="%">
        </div>
    </div>
    ...
    <div class="col-md-3 col-12">
        <div class="form-group">
            ...
            <input type="text" class="form-control discount_expire_at persian-date-picker" data-timestamps="true" name="discount_expire_at" value="{{ $price->discount_expire_at ? jdate($price->discount_expire_at)->getTimestamp() : '' }}">
        </div>
    </div>
    ...
    <div class="col-md-3 col-12">
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="cart_max" value="{{ $price->cart_max }}" min="1">
        </div>
    </div>
    ...
    <div class="col-md-3 col-12">
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="cart_min" value="{{ $price->cart_min }}" min="1">
        </div>
    </div>
    ...
    <div class="col-md-3 col-12">
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="stock" value="{{ $price->stock }}" min="0" required>
        </div>
    </div>
    ...
    <div class="col-md-3 col-12">
        ...
        <div class="col-md-3 col-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control final-price" value='{{number_format($price->discount_price)}} تومان' disabled>
            </div>
        </div>
    @if(option('multi_vendor_system_status','false')=="true")
        <div class="col-md-6">
            <div class="form-group">
                <label>فروشنده</label>
                <select class="form-control sellers" name="seller_id">
                    <option value="">انتخاب کنید</option>
                    @foreach ($sellers as $seller)
                        <option {{ ($seller->id == $price->seller_id) ? 'selected' : '' }} value="{{ $seller->id }}">
                            {{ $seller->id . ' - ' . ($seller->seller_info->business_name ?: $seller->seller_info->full_name) }}
                        </option>
                    @endforeach
                </select>
            </div>
