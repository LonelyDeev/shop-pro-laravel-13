            ...
            <div class="content-body">
                ...
                <section class="card">
                    <div class="card-header">
                        ...
                        <div>
                            <a href="{{ route('admin.wallets.show', ['wallet' => $wallet]) }}" class="btn personal-warning-btn waves-effect waves-light"><i class="fa-solid fa-arrow-left float-right ml-1"></i>بازگشت به کیف پول </a>
                        </div>
                    </div>
