                    ...
                    <div id="main-card" class="card-content">
                        <div class="card-body">
                            <div class="row g-4">
                                ...
                                <div class="col-lg-7">
                                    <form id="create-new-story" method="post" action="{{route('admin.stories.store')}}" data-redirect="{{ route('admin.stories.index') }}" class=" p-2">

                                        <!-- عنوان -->
                                        <div class="form-group">
                                            <label class="form-label fw-semibold">عنوان</label>
                                            <input name="title" type="text" class="form-control" id="storyTitle"
                                                   placeholder="مثال: پیشنهاد شگفت‌انگیز">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="upload-box d-flex align-items-center justify-content-between"
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <span id="coverFileName" class="text-muted small">هیچ فایلی انتخاب نشده</span>
                                                </div>
                                                <span class="badge bg-light text-dark">انتخاب +</span>
                                            </div>
                                            <input type="file" name="cover_image" id="coverUpload" accept="image/*" class="d-none">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="type" id="storyType" class="form-control">
                                                <option value="image" selected>تصویری</option>
                                        ...
                                        <div class="form-group" id="imageContentContainer">
                                            ...
                                            <div class="upload-box d-flex align-items-center justify-content-between"
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <span id="contentFileName" class="text-muted small">هیچ فایلی انتخاب نشده</span>
                                                </div>
                                                <span class="badge bg-light text-dark">انتخاب +</span>
                                            </div>
                                            <input type="file" name="image" id="contentImageUpload" accept="image/*" class="d-none">
                                            ...
                                            <div class="form-group mt-1">
                                                ...
                                                <input name="duration" type="number" class="form-control" id="storyDuration"
                                                       placeholder="مثال: 10">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="expiry_date" id="expiryDate">
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="widget_title" type="text" class="form-control" id="widgetTitle"
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="widget_link" type="text" class="form-control" id="widgetLink"
                                        ...
                                        <div class="col-md-8 mb-3 mt-2 d-flex justify-content-between">
                                            <fieldset class="checkbox">
                                                <div class="vs-checkbox-con vs-checkbox-primary">
                                                    <input type="checkbox" name="active_likes" value="1" checked="">
                                            ...
                                            <fieldset class="checkbox">
                                                <div class="vs-checkbox-con vs-checkbox-primary">
                                                    <input type="checkbox" name="active_comments" value="1" checked="">
                                                    <span class="vs-checkbox">
                                                            <span class="vs-checkbox--check">
                                                                <i class="vs-icon feather icon-check"></i>
                                                            </span>
                                        ...
                                        <div class="d-flex gap-2 d-flex justify-content-between mt-2">
                                            <button type="submit" class="btn btn-primary mr-1 mb-1 waves-effect waves-light">+ ایجاد استوری</button>
...
{{--                                                                            class="fw-bold">5</span></span>--}}
                                                ...
                                                <div class="story-header">
                                                    <div class="preview-coverImg" id="previewCoverImg">
                                                        <img id="coverThumb" class="preview-img-thumb" src="" alt="">
                                                    </div>
                                                    <!-- عنوان استوری -->
...
@push('scripts')
    <script>
        var editStory=false
        var existContentImage=false
        var existContentVideo=false
    </script>
    <script src="{{ asset('back/assets/js/pages/stories/all.js') }}"></script>
    <script src="{{ asset('back/assets/js/pages/stories/create.js') }}"></script>
@endpush
