            ...
            <div class="content-body">
                <div class="card overflow-hidden">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" data-auto-complete-url="{{ route('admin.orders.userInfo') }}"
                                id="order-create-form" action="{{ route('admin.orders.store') }}"
                                data-redirect="{{ route('admin.orders.index') }}" method="post">
                                @csrf
                                    ...
                                    <ul class="nav nav-tabs nav-left flex-column" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="user-info-tab" data-toggle="tab"
                                                aria-controls="user-info-tab-content" href="#user-info-tab-content"
                                                role="tab" aria-selected="true">اطلاعات کاربر</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="address-tab" data-toggle="tab"
                                                aria-controls="address-tab-content" href="#address-tab-content"
                                                role="tab" aria-selected="false">آدرس</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="products-tab" data-toggle="tab"
                                                aria-controls="products-tab-content" href="#products-tab-content"
                                                role="tab" aria-selected="false">انتخاب محصولات</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="order-info-tab" data-toggle="tab"
                                                aria-controls="order-info-tab-content" href="#order-info-tab-content"
                                                role="tab" aria-selected="false">اطلاعات سفارش</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="user-info-tab-content" role="tabpanel"
                                        ...
                                        <div class="tab-pane" id="address-tab-content" role="tabpanel"
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="province"
                                                                ...
                                                                name="province_id" class="form-control">
                                        ...
                                        <div class="tab-pane" id="products-tab-content" role="tabpanel"
                                            aria-labelledby="products-tab">
                                            <div class="col-12" id="order-products-list"></div>

                                            <div class="col-md-8 offset-md-2  mt-2 position-relative">
                                                <label> افزودن محصولات</label>
                                                <input id="add-product-to-order"
                                                    data-action="{{ route('admin.orders.productsList') }}" type="text"
                                                    placeholder=" حداقل 3 کلمه وارد کنید" class="form-control">
                                                <div class="add-product-to-order-loader"></div>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="order-info-tab-content" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="col-12 text-right">
                                        <button type="submit"
                                            class="btn btn-primary mr-1 mb-1 waves-effect waves-light">ثبت سفارش</button>
                                    </div>
                                </div>
                            </form>
                        </div>
