            ...
            setupSystemColumn: function() {
                ...
                $(datatable.tableBody).find('.' + pfx + 'datatable-row').each(function(tri, tr) {
                    $(tr).find('.' + pfx + 'datatable-cell').each(function(tdi, td) {
                        ...
                        if (typeof column !== 'undefined') {
                            ...
                            if (typeof column.selector !== 'undefined' && column.selector !== false) {
                                ...
                                if ($(td).find('.checkbox input[type="checkbox"]').length > 0) return;

                                $(td).addClass(pfx + 'datatable-cell-check');

                                // ساخت چک‌باکس با استایل جدید (مثل هدر)
                                var chk = $(`
                    ...
                    `);
                                ...
                                chk.find('input[type="checkbox"]').on('click', function() {
                                    if ($(this).is(':checked')) {
                                ...
                                if (typeof column.selector.class !== 'undefined') {
                                    chk.find('.vs-checkbox-con').addClass(column.selector.class);
                                }
                ...
                var initCheckbox = function(tr) {
                    ...
                    if (typeof column !== 'undefined') {
                        ...
                        if (typeof column.selector !== 'undefined' && column.selector !== false) {
                            ...
                            // ساخت چک‌باکس با استایل جدید برای هدر
                            var chk = $(`
                    <fieldset class="checkbox">
                ...
                `);
                            ...
                            // اگر کلاس خاصی در selector تعریف شده بود
                            if (typeof column.selector.class !== 'undefined') {
                                chk.find('.vs-checkbox-con').addClass(column.selector.class);
                            }
