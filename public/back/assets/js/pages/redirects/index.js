...
$(document).on('click', '.btn-delete', function() {
    $('#redirects-delete-form').attr('action', BASE_URL + '/redirects/' + $(this).data('post'));
    $('#redirects-delete-form').data('id', $(this).data('id'));
});

$('#redirects-delete-form').submit(function(e) {
    e.preventDefault();
...
$('#redirects-multiple-delete-form').on('submit', function (e) {
    e.preventDefault();
