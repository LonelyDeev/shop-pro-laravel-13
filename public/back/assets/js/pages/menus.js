        ...
        case 'megamenu':
            {
                ...
                $('#menu-title-div, #menu-icon-div, #menu-link-div').show();
                break;
            }

        case 'category':
            {
                $('#menu-title-div, #menu-icon-div, #menu-link-div, #menu-static-div').hide();
        ...
        case 'static':
            {
                ...
                $('#menu-title-div, #menu-icon-div, #menu-static-div').show();
                break;
            }
        ...
        case 'megamenu':
            {
                ...
                $('#edit-menu-title-div, #edit-menu-icon-div, #edit-menu-link-div').show();
                break;
            }

        case 'category':
            {
                $('#edit-menu-title-div, #edit-menu-icon-div, #edit-menu-link-div, #edit-menu-static-div').hide();
        ...
        case 'static':
            {
                ...
                $('#edit-menu-title-div, #edit-menu-icon-div, #edit-menu-static-div').show();
                break;
            }
    }
});
...
$(document).on('click', '.edit-menu', function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('#edit-form input[name="icon"]').val(data.menu.icon);
            $('#edit-form input[name="category_icon"]').val(data.menu.icon);
