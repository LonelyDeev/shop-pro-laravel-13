...
class SellerProductCreated extends Notification implements ShouldQueue
{
    use Queueable;
    public $seller;
    public $product;
    ...
    {
        return [
            'message' => 'فروشگاه "'.$this->seller_info->business_name.'" یک محصول، با عنوان "'.$this->product->title.'" اضافه کرد.'
        ];
    }
    public function databaseType()
    {
        return 'SellerProductCreated';
    }

    public function toWebPush($notifiable, $notification)
    {
        return (new WebPushMessage)
            ->title('فروشگاه "'.$this->seller_info->business_name.'" یک محصول، با عنوان "'.$this->product->title.'" اضافه کرد.')
